...
#set.seed(sim = loop)
 ...
 COMMUTEout = tryCatch(simu(k*LOOP+loop, p, s, K, n0, nt, h, sig.delta, intercept, exact, r, n.test,hrecordnumber), error=function(err) list(matrix(NA,7,4)))
